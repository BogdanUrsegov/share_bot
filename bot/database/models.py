from sqlalchemy import Integer, DateTime, BigInteger, Boolean, Numeric, String, ForeignKey, UniqueConstraint
...
class ReferralClick(Base):
    ...
    __table_args__ = (
        UniqueConstraint("referral_id", "telegram_id", name="uq_referral_click_user"),
    )
